...
export class ProgramacionService {
  ...
  cambiarEstado(id: number, nuevoEstado: number): Observable<Programacion> {
    if (environment.useMocks) {
    ...
    return this.http.put<Programacion>(`${this.apiUrl}/programaciones/${id}/estado`, { id_estado: nuevoEstado });
  }
  ...
  rechazarCoordinador(id: number): Observable<Programacion> {
    return this.cambiarEstado(id, 4);
  }
  ...
  rechazarDecano(id: number): Observable<Programacion> {
    return this.cambiarEstado(id, 6);
  }
